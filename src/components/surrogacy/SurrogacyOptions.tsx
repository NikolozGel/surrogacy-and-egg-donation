...
export default function SurrogacyAndEggDonationOptions() {
  ...
  return (
    <div className="px-5 md:px-20 absolute bottom-[15%] md:bottom-[38%] md:left-[10%]">
      <div>
        ...
        <div>
          <CustomModal
            trigger={
              <button className="p-3 sm:p-3.75 rounded-full bg-[#4287f5] hover:opacity-80 text-white cursor-pointer text-md lg:text-2xl font-semibold">
                {t("cta")}
              </button>
            }
          >
