    ...
    <div className="px-5 md:px-20 absolute bottom-[38%] md:left-[10%]">
      <div>
        <div className="p-3 mb-6 inline-block">
          <p className="text-xl md:text-2xl text-secondary! italic text-white">
            {t("quote")}
        ...
        <div>
          <CustomModal
            trigger={
              <button className="p-2 sm:p-5 rounded-full bg-[#4287f5] hover:opacity-80 text-white cursor-pointer text-md lg:text-2xl font-semibold">
                {t("cta")}
              </button>
            }
          >
