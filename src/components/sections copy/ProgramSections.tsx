...
import clinicInterior from "@/../public/assets/ivf/ivf-2.jpg";
import motherBaby from "@/../public/assets/mother/mother.jpg";
import embryoLab from "@/../public/assets/egg-donation/microscope.jpg";
...
const ProgramSections = () => {
  return (
    <section className="w-full pt-20 bg-card">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {services.map((s) => (
            <Link key={s.title} href={s.link} className="group h-full">
              <div className="bg-card h-full overflow-hidden border border-[#d2c2c2] flex flex-col">
